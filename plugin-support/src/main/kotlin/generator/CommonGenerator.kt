 ...
 */
internal interface CommonGenerator {
    fun qName(symbol: InternalSymbol): CodeBlock
    fun sig(symbol: InternalSymbol.Function): CodeBlock

    companion object : CommonGenerator {
        override fun qName(symbol: InternalSymbol): CodeBlock {
            return when (symbol) {
        ...
        override fun sig(symbol: InternalSymbol.Function): CodeBlock {
